...
void CCBSPWorld::IBSPWorld(short initialObjectSpace) {
...
void CCBSPWorld::AddPart(CBSPPart *thePart) {
...
void CCBSPWorld::RemovePart(CBSPPart *thePart) {
    short i;
    CBSPPart **p;
...
*/
void CCBSPWorld::ScoreAndSort(CBSPPart **firstPart, short overlapCount) {
    CBSPPart *compPart;
...
void CCBSPWorld::OverheadPoint(Fixed *c) {
    Fixed minX = FIX(9999),
          maxX = FIX(-9999),
          minZ = FIX(9999),
          maxZ = FIX(-9999),
...
void CCBSPWorld::VisibilitySort(CBSPPart **parts, short overlapCount) {
    CBSPPart *thePart;
    CBSPPart *listStart;
    CBSPPart **prevLink;
...
void CCBSPWorld::SortVisibleParts() {
...
void CCBSPWorld::Render(CViewParameters *theView) {
    short i;
    CBSPPart **sp, **sd;
...
CBSPPart *CCBSPWorld::GetIndPart(short ind) {
